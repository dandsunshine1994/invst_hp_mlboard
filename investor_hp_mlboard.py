...
# ==== 尝试加载核心产物 ====
missing = []
base_path = MET_DIR / "base_models_base.csv"
cov_path  = MET_DIR / "base_models_cov.csv"
aurc_path = MET_DIR / "base_models_aurc.csv"
ext_path  = MET_DIR / "base_models_ext_reports.json"
